...
public class GetUserData extends TestBase{
	...
	public void i_want_to_setup_the_endpoint_url_of_GET_Api_for_single_user_not_found() throws Throwable {
	   ...
	   testLogger.logMessage("The Endpoint Url is "+configFileReader.getPropertyValue("getEndpointforSingleUserNotFoundURL"));
	}
	...
	public void i_should_validate_the_response_Body_fields(String expectedId, String expectedEmail, String expectedFirstName, String expectedLastName, String expectedAvatar) throws Throwable {
		String actualId=apiSetup.getResponseByPath("data.id");
	    testLogger.assertEquals(expectedId, actualId, "The Actual is is "+actualId);
	    String actualEmail=apiSetup.getResponseByPath("data.email");
	    testLogger.assertEquals(expectedEmail, actualEmail, "The Actual is is "+actualEmail);
	    ...
	    testLogger.assertEquals(expectedAvatar, actualAvatar, "The actual last name is "+actualAvatar);
	}
	...
	public void i_should_validate_the_status_code_is(int expectedStatusCode) throws Throwable {
		 ...
		 testLogger.assertEquals(expectedStatusCode, actualStatusCode, "Validating the status code is "+actualStatusCode);
	...
	@Then("^I should validate the response Body fields \"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\"$")
	public void i_should_validate_the_response_Body_fields(String expectedPage, String expectedTotal, String expectedId, String expectedEmail, String expectedFirstName, String expectedLastName, String expectedAvatar) throws Throwable {
	    ...
	    testLogger.assertEquals(expectedTotal, actualTotal, "The Actual total valus is "+actualTotal);
	    String actualId=apiSetup.getResponseByPath("data[0].id");
	    testLogger.assertEquals(expectedId, actualId, "The Actual is is "+actualId);
	    String actualEmail=apiSetup.getResponseByPath("data[0].email");
	    testLogger.assertEquals(expectedEmail, actualEmail, "The Actual Email "+actualEmail);
